...
const CV = () => {
  return (
    <main className="max-w-5xl mx-auto p-10 bg-[#141414] text-white flex flex-col items-center space-y-10">
      {/* Encabezado */}
      ...
      <section className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <article className="bg-gray-900 p-6 rounded-lg shadow-lg border-l-4 border-blue-500">
          ...
          <p className="text-gray-300 mt-3">
            Soy desarrollador web junior con una sólida base en tecnologías web
            y entusiasmo por la programación. Busco crecer profesionalmente en
            IT, mejorando mis habilidades y aportando soluciones innovadoras.
          </p>
        </article>
      ...
      <footer className="bg-gray-900 p-6 rounded-lg shadow-lg w-full text-center border-t-4 border-gray-500">
        ...
        <div className="mt-3 text-gray-300 space-y-2">
          ...
          <p className="flex items-center justify-center gap-2">
            <FaGithub />
            <a href="https://github.com/Enzoolionel" className="text-blue-400">
              GitHub
            </a>
          </p>
          <p className="flex items-center justify-center gap-2">
            <FaSuitcase />
            <a href="https://enzoolionel.vercel.app" className="text-blue-400">
              Portafolio
            </a>
          </p>
        </div>
